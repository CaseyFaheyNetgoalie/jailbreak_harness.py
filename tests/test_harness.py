...
def basic_test_case():
    ...
    variant = Variant(
        id="T1.v1", prompt="LAB_OK prompt", system_note="System", temperature=0.5
    )
    return TestCase(
        id="T1",
        name="Basic Test",
...
def complex_test_cases():
    ...
    return [
        TestCase(
            ...
            variants=[variant_sweep, variant_fixed],
        )
    ]
...
class TestReportingAndExport:
    ...
    def harness_with_results(self, mock_caller):
        ...
        test1 = TestCase(
            ...
            name="N1",
            description="D1",
            variants=[Variant(id="T1.v1", prompt="p1")],
        )
        test2 = TestCase(
            id="T2",
            name="N2",
            description="D2",
            variants=[Variant(id="T2.v1", prompt="p2", temperature=0.5)],
        )
